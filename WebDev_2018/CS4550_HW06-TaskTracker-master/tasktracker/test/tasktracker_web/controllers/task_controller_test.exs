defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{complete: true, description: "some description", time_spent: 42, title: "some title"}
  @update_attrs %{complete: false, description: "some updated description", time_spent: 43, title: "some updated title"}
  @invalid_attrs %{complete: nil, description: nil, time_spent: nil, title: nil}
